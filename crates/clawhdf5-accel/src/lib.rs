...
pub fn dot_product(a: &[f32], b: &[f32]) -> f32 {
    match detect_backend() {
        #[cfg(target_arch = "aarch64")]
        // SAFETY: NEON is always available on aarch64; runtime detection ensures this arm.
        Backend::Neon => unsafe { neon::dot_product(a, b) },

        #[cfg(all(target_arch = "x86_64", feature = "avx512"))]
        // SAFETY: detect_backend() verified avx512f support before selecting this arm.
        Backend::Avx512 => unsafe { avx512::dot_product(a, b) },

        #[cfg(target_arch = "x86_64")]
        // SAFETY: detect_backend() verified avx2 support before selecting this arm.
